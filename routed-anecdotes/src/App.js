...
const Menu = ({ addNew, anecdotes, anecdoteById, newNotification, notification }) => {
  const padding = {
    paddingRight: 5
  }
  return (
      ...
      <Router>
        <div>
          <div>
            ...
            <Route path="/create" render={() => <CreateNew addNew={addNew} newNotification={newNotification}/>} />
...
const Anecdote = ({anecdote, anecdoteById}) =>  {
  return (
    <div>
...
const AnecdoteList = ({ anecdotes, anecdoteById }) => (
  <div>
    <h2>Anecdotes</h2>
    <ul>
...
const App = () => {
  ...
  const newNotification = (anecdote) => {
  ...
  return (
    <div>
      ...
      <Menu addNew={addNew} anecdotes={anecdotes} anecdoteById={anecdoteById} newNotification={newNotification} notification={notification} />
      <Footer />
    </div>
  )
}
